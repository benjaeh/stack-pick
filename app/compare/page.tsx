...
export const metadata: Metadata = {
  ...
  description:
    "We gave the same prompts to the top AI tools. Here are the real outputs — so you can see the difference before you pay.",
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="mt-16 bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
        ...
        <div className="mt-4">
          <Link href="/vs" className="text-sm text-primary font-semibold hover:underline">
